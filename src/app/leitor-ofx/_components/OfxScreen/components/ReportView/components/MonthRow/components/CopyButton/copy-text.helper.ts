// The clipboard write, split out of the hook so the failure path is explicit
// rather than buried in a handler. It is the path that matters: a failure that
// looks like success means the owner pastes whatever was on the clipboard
// before.
