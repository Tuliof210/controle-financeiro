// The 27 kit glyphs, `d` copied verbatim from design-system/components/core/Icon.jsx.
export const KIT_ICONS = {
  wallet:
    "M3 8.5A2.5 2.5 0 0 1 5.5 6H18a2 2 0 0 1 2 2v1M3 8.5V17a2 2 0 0 0 2 2h13a2 2 0 0 0 2-2v-2M3 8.5V8m18 4h-4a2 2 0 0 0 0 4h4",
  ...
  minus: "M5 12h14",
  repeat:
    "M17 2l4 4-4 4M3 11V9a4 4 0 0 1 4-4h14M7 22l-4-4 4-4m14 5v2a4 4 0 0 1-4 4H3",
  calendar:
  ...
  sparkles:
    "M12 4l1.6 4.4L18 10l-4.4 1.6L12 16l-1.6-4.4L6 10l4.4-1.6L12 4ZM19 15l.8 2.2L22 18l-2.2.8L19 21l-.8-2.2L16 18l2.2-.8L19 15Z",
  ...
  banknote:
    "M4 7a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V7Zm8 5m-2.5 0a2.5 2.5 0 1 0 5 0a2.5 2.5 0 1 0-5 0M7 9v.01M17 15v.01",
} as const;
