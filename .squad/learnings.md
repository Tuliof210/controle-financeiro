...
- [architecture] "Teto" is the ALLOWANCE (`CeilingMonth.budget`), never a projected balance — they run ~4.5x apart, so labelling a balance `teto` makes the card contradict its own headline; call it `saldo` (2026-07-30)
