...
## Tasks
- [ ] tasks/01-drop-stale-nav-assertion.md — unrelated red spec left by the installments revert, fixed first so the suite is a usable baseline
- [ ] tasks/02-rename-forecast-tables.md — Prisma models + hand-written data-preserving SQLite migration
